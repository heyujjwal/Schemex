            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="flex justify-between h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <Link to="Scheme" className="text-gray-800 dark:text-white text-xl hover:text-blue-800 dark:hover:text-blue-400">Schemes</Link>
            ...
            {isOpen && (
                <div className="md:hidden">
                    <div className="px-2 pt-2 pb-3 space-y-1 bg-white dark:bg-gray-800">
                        ...
                        <Link to="/scheme" className="block px-3 py-2 text-gray-600 dark:text-white hover:bg-blue-50 dark:hover:bg-gray-700 rounded-md">Schemes</Link>
